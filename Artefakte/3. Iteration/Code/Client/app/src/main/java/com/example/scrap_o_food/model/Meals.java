...
public class Meals {
    ...
    public Meals ( int idMeal, int idUser, int idGroup, String strMeal, String strDescription, double longitude, double latitude,
                   String adDate, String strCategory, String strStoring, String strCondition, String strMHD, String strMealThumb,
                   String strMail, int strPhone) {
        this.idMeal = idMeal;
        this.idUser = idUser;
    ...
    public void setMeals(List<Meal> meals) {
        ...
        public int getStrPhone() {
            return strPhone;
        }

        public void setStrPhone(int strPhone) {
            this.strPhone = strPhone;
        }
